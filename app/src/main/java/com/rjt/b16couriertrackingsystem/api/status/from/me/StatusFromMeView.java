...
public class StatusFromMeView extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_fromme_status_view, container, false);
        recyclerView = view.findViewById(R.id.recyclerViewFromMe);
        ...
        Call<StatusResponseList> call = statusResponseService.getResponseFromMe(email, "1");
